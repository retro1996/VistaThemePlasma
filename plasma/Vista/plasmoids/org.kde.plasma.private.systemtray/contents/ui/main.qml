...
ContainmentItem {
    ...
    readonly property alias hiddenLayout: hiddenTasksGrid
    ...
    MouseArea {
        ...
        GridLayout {
            ...
            ExpanderArrow {
                ...
                visible: root.hiddenTasksGrid.itemCount > 0
            }
            ...
            GridView {
                ...
                readonly property int itemCount: model.count // for expanderarrow
