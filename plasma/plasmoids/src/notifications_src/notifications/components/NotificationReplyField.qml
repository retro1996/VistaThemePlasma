...
RowLayout {
    ...
    PlasmaComponents3.TextField {
        ...
        placeholderText: replyRow.modelInterface.replyPlaceholderText
                         || i18ndc("plasma_applet_io.gitgud.catpswin56.notifications", "Text field placeholder", "Type a reply…")
    ...
    PlasmaComponents3.Button {
        ...
        text: replyRow.modelInterface.replySubmitButtonText
              || i18ndc("plasma_applet_io.gitgud.catpswin56.notifications", "@action:button", "Send")
