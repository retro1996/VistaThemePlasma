...
ColumnLayout {
    ...
    RowLayout {
        ...
        PlasmaComponents3.Label {
            ...
            // BUG: 451807
            text: i18ndc("plasma_applet_io.gitgud.catpswin56.notifications", "Percentage of a job", "%1%", jobItem.modelInterface.percentage || "0")
    ...
    Row {
        ...
        PlasmaComponents3.Button {
            ...
            Accessible.name: i18nd("plasma_applet_io.gitgud.catpswin56.notifications", "More Options…")
            onPressedChanged: {
                if (pressed) {
        ...
        PlasmaComponents3.Button {
            ...
            text: i18nd("plasma_applet_io.gitgud.catpswin56.notifications", "Open")
            ...
            states: [
                State {
                    ...
                    PropertyChanges {
                        target: openButton
                        text: i18nd("plasma_applet_io.gitgud.catpswin56.notifications", "Open Containing Folder")
