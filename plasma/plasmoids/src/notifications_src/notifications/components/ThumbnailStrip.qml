    ...
    KQCAddons.QPixmapItem {
        ...
        RowLayout {
            ...
            PlasmaComponents3.Button {
                ...
                PlasmaComponents3.ToolTip {
                    id: tooltip
                    text: i18nd("plasma_applet_io.gitgud.catpswin56.notifications", "More Options…")
                }
            }
        }
        RowLayout {
            ...
            PlasmaComponents3.Button {
                ...
                PlasmaComponents3.ToolTip {
                    id: backTooltip
                    text: i18nd("plasma_applet_io.gitgud.catpswin56.notifications", "Previous")
                }
            }
            PlasmaComponents3.Button {
                id: nextButton
                ...
                PlasmaComponents3.ToolTip {
                    id: nextTooltip
                    text: i18nd("plasma_applet_io.gitgud.catpswin56.notifications", "Next")
                }
            }
