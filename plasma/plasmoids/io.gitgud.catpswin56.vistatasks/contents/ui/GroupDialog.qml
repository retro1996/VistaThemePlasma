...
PlasmaCore.Dialog {
    ...
    objectName: "vistatasks_groupdialog"

    readonly property real preferredWidth: Screen.width / (3 * Screen.devicePixelRatio)
    readonly property real preferredHeight: LayoutMetrics.preferredTaskHeight()*groupListView.count
    ...
    mainItem: MouseHandler {
        id: mouseHandler
        width: 158
        height: groupDialog.preferredHeight
