...
RowLayout {
    ...
    readonly property int paintedWidth: previousBtn.width+playbackBtn.width+skipBtn.width+muteBtn.width
    ...
    MediaButton {
        ...
        visible: Plasmoid.configuration.showPreviewMpris && root.playerData !== null
        iconWidth: 13
        iconHeight: 11
    }
    MediaButton {
    ...
    MediaButton {
        id: skipBtn
        orientation: Plasmoid.configuration.showPreviewMute ? "center" : "right"
        mediaIcon: "skip"
    ...
    MediaButton {
        id: muteBtn
        orientation: Plasmoid.configuration.showPreviewMpris && root.playerData !== null ? "right" : "single"
        mediaIcon: root.parentTask.muted ? "unmute" : "mute"
        onClicked: root.parentTask.toggleMuted();
        enableButton: visible
        visible: Plasmoid.configuration.showPreviewMute
